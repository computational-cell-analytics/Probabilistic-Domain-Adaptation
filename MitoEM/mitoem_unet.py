...
def get_mitoem_loaders(data_path, patch_shape = (1, 512, 512), 
...
def do_unet_predictions(device, data_path:str, pred_path:str, em_type:str):
    ...
    root_output = pred_path + f"unet_predictions/"
    ...
    model_save_dir = f"checkpoints/unet-source-mitoemv2/best.pt"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, default="~/data/", help="Path where the dataset already exists/will be downloaded by the dataloader")
